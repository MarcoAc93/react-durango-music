...
const NewStudent = () => {
  ...
  const onError = (error: any) => {
    setError({ title: 'Hubo un error...', description: error?.message, continue: handleCloseModal })
    handleOpenModal();
  };
  ...
  return (
    <>
      ...
      <Modal
        ...
        description={!error.description ? 'El alumno a sido agregado correctamente, deseas registrar su inscripcion?' : error.description}
        handleClose={handleCloseModal}
        onContinue={!error.description ? () => console.log('Continuar!!!') : error.continue}
      />
    </>
  )
};
